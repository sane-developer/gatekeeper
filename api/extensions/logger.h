...
///
#define write_info_log(format_with_args) write_custom_log(INFO, (format_with_args))

///
/// @brief Writes a log of warning severity.
/// @param format_with_args The format and arguements meant to shape a log.
///
#define write_warning_log(format_with_args) write_custom_log(WARNING, (format_with_args))

///
/// @brief Writes a log of critical severity.
/// @param format_with_args The format and arguements meant to shape a log.
///
#define write_critical_log(format_with_args) write_custom_log(CRITICAL, (format_with_args))
